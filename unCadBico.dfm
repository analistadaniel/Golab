object FormCadBico: TFormCadBico
  Left = 0
  Top = 0
  ...
  object Panel2: TPanel
    ...
    object DBLookupComboBox1: TDBLookupComboBox
      ...
      DataSource = dsCadBico
      KeyField = 'ID_BOMBA'
      ListField = 'ID_BOMBA;DESC_BOMBA'
      ListSource = dsADOQueryCadBomba
      TabOrder = 1
    end
    object DBLookupComboBox2: TDBLookupComboBox
      ...
      ListField = 'ID_COMBUSTIVEL;TIPO'
      ListSource = dsADOQueryCadTipoComb
      TabOrder = 2
    end
  end
  ...
  object dsADOQueryCadTipoComb: TDataSource
    DataSet = DM.ADOQueryCadTipoComb
    Left = 360
    Top = 72
  end
  object ADOQuery1: TADOQuery
    ...
    SQL.Strings = (
        ...
        'select B.BICO, C.TIPO, BB.DESC_BOMBA, B.VALOR_LITRO, BB.POSTO fr' +
        'om GOLAB_BICO B'
      'inner join GOLAB_CADBOMBA BB ON B.ID_BOMBA = BB.ID_BOMBA'
      
        'inner join GOLAB_TIPOCOMBUSTIVEL C ON B.ID_COMBUSTIVEL = C.ID_CO' +
        'MBUSTIVEL')
    Left = 592
    Top = 264
    object ADOQuery1BICO: TIntegerField
      FieldName = 'BICO'
    end
    ...
    object ADOQuery1DESC_BOMBA: TStringField
      FieldName = 'DESC_BOMBA'
      Size = 30
    end
    object ADOQuery1VALOR_LITRO: TBCDField
      FieldName = 'VALOR_LITRO'
      Precision = 5
      Size = 3
    end
    object ADOQuery1POSTO: TStringField
      FieldName = 'POSTO'
    end
  end
