...
Try
 if (DM.ADOQueryCadBico.RecordCount = 0) or(DM.ADOQuerycadBomba.RecordCount = 0) or
  ...
  begin
   showmessage('É necessário realizar alguns cadastros antes de fazer lançamentos!');
  end
  else
   begin
