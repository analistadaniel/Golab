object FormCadFPgto: TFormCadFPgto
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu, biMinimize]
  Caption = 'FormCadFPgto'
  ClientHeight = 481
  ClientWidth = 676
  Color = clBtnFace
  ...
  object Panel2: TPanel
    ...
    object Label3: TLabel
      ...
      Width = 132
      Height = 13
      Caption = 'Descri'#231#227'o dos Lan'#231'amentos'
  ...
  object DBGrid1: TDBGrid
    ...
    Columns = <
      ...
      item
        Expanded = False
        FieldName = 'DESC_FORMAPGTO'
        Title.Caption = 'Descri'#231#227'o'
        Width = 450
        Visible = True
      end>
  end
  object dsCadFPgto: TDataSource
    DataSet = DM.ADOQueryCadFPgto
    Left = 512
    Top = 88
  end
end
