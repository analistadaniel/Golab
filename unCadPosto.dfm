object FormCadPosto: TFormCadPosto
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu, biMinimize]
  Caption = 'FormCadPosto'
  ClientHeight = 485
  ClientWidth = 669
  Color = clBtnFace
  ...
  object DBGrid1: TDBGrid
    ...
    Columns = <
      ...
      item
        ...
        Title.Caption = 'Respons'#225'vel Tecnico'
        Width = 150
        Visible = True
      end
      item
