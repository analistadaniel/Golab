object FormCadAliquota: TFormCadAliquota
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu, biMinimize]
  Caption = 'Cadastro de Aliquota'
  ClientHeight = 487
  ClientWidth = 676
  Color = clBtnFace
  ...
  object Panel2: TPanel
    ...
    object Label4: TLabel
      ...
      Width = 103
      Height = 13
      Caption = 'Descri'#231#227'o da Aliquota'
    ...
    object DBEdit1: TDBEdit
      ...
      Color = cl3DLight
      DataField = 'ID_IMP'
      DataSource = dsADOQueryCadAliquota
      ReadOnly = True
      TabOrder = 0
    end
  ...
  object dsADOQueryCadAliquota: TDataSource
    DataSet = DM.ADOQueryCadAliquota
    Left = 352
    Top = 160
  end
end
