object FormCadUser: TFormCadUser
  Left = 0
  Top = 0
  ...
  object Panel2: TPanel
    ...
    object Label2: TLabel
      ...
      Width = 103
      Height = 13
      Caption = 'ID Usu'#225'rio - Matricula'
    end
    ...
    object DBEdit1: TDBEdit
      ...
      Height = 21
      Color = cl3DLight
      DataField = 'ID_CADUSER'
      DataSource = dsCadUser
      Font.Charset = DEFAULT_CHARSET
    ...
    object DBLookupComboBox1: TDBLookupComboBox
      ...
      Width = 337
      Height = 21
      Hint = 'Selecione para qual funcion'#225'rio deseja criar usu'#225'rio'
      DataField = 'USERMATRICULA'
      DataSource = dsCadUser
      KeyField = 'MATRICULA'
      ListField = 'MATRICULA;NOMEFUNC'
      ListSource = dsCadFunc
      TabOrder = 2
  ...
  object dsCadUser: TDataSource
    DataSet = DM.ADOQueryCadUser
    Left = 504
    Top = 64
  end
  object dsCadFunc: TDataSource
    DataSet = DM.ADOQueryCadFunc
    Left = 568
    Top = 64
  end
  object ADOQueryFuncUser: TADOQuery
    Active = True
    ...
    SQL.Strings = (
        ...
        'select F.MATRICULA, F.NOMEFUNC, F.FUNCAO, U.ATIVO from GOLAB_CAD' +
        'FUNCIONARIO F'
      'INNER JOIN GOLAB_CADUSER U ON U.USERMATRICULA = F.MATRICULA')
    Left = 458
    Top = 242
    object ADOQueryFuncUserMATRICULA: TStringField
      FieldName = 'MATRICULA'
    end
    object ADOQueryFuncUserNOMEFUNC: TStringField
      FieldName = 'NOMEFUNC'
      Size = 50
    end
    object ADOQueryFuncUserFUNCAO: TStringField
      FieldName = 'FUNCAO'
      Size = 50
    end
    object ADOQueryFuncUserATIVO: TStringField
      FieldName = 'ATIVO'
      FixedChar = True
      Size = 1
    end
  end
  object dsADOQueryFuncUser: TDataSource
    DataSet = ADOQueryFuncUser
    Left = 352
    Top = 240
  end
end
